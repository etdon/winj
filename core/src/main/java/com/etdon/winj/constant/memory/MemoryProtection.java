...
public final class MemoryProtection {
     ...
     * private page is marked as PAGE_EXECUTE_READWRITE, and the change is written to the new page.
     * <p>
     * This flag is not supported by the VirtualAlloc or VirtualAllocEx functions.
     * <p>
     * Windows Vista, Windows Server 2003
     * and Windows XP: This attribute is not supported by the CreateFileMapping function until Windows Vista with SP1
     ...
     * PAGE_EXECUTE, PAGE_EXECUTE_READ, PAGE_EXECUTE_READWRITE and PAGE_EXECUTE_WRITECOPY. Any indirect call to
     * locations in those pages will fail CFG checks and the process will be terminated. The default behavior for
     * executable pages allocated is to be marked valid call targets for CFG.
     * <p>
     ...
     * executable type like PAGE_EXECUTE, PAGE_EXECUTE_READ, PAGE_EXECUTE_READWRITE and PAGE_EXECUTE_WRITECOPY. The
     * default behavior for VirtualProtect protection change to executable is to mark all locations as valid call
     * targets for CFG.
     */
