...
public final class Instruction_AND_RM64_IMM8 extends Instruction {
    ...
    private Instruction_AND_RM64_IMM8(final Register destination,
                                      final byte value) {
    ...
    public static Instruction_AND_RM64_IMM8 of(@NotNull final Register destination, final byte value) {
