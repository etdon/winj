...
public final class Instruction_XOR_RM64_IMM8 extends Instruction {
    ...
    private Instruction_XOR_RM64_IMM8(final Register destination,
                                      final byte value) {
    ...
    public static Instruction_XOR_RM64_IMM8 of(@NotNull final Register destination, final byte value) {
