...
public final class Instructions {
    ...
    public static final InstructionDefinition PUSH_R64 = InstructionDefinition.of(Opcode.of(0x50), com.etdon.winj.facade.assembler.operand.encoding.OR.getInstance());
    ...
    public static class ADD {
        ...
        public static final InstructionDefinition RM8_R8 = InstructionDefinition.of(Opcode.of(0x00), RM_R.getInstance());
        public static final InstructionDefinition RM64_R64 = InstructionDefinition.of(Opcode.of(0x01), RM_R.getInstance());
        ...
        public static final InstructionDefinition RM64_IMM8 = InstructionDefinition.of(Opcode.of(0x83), RM_IMM.getInstance());
    ...
    public static final class OR {
        ...
        public static final byte RM8_IMM8 = (byte) 0x80;
        public static final byte RM64_IMM32 = (byte) 0x81;
        public static final InstructionDefinition RM64_IMM8 = InstructionDefinition.of(Opcode.of(0x83, 1), RM_IMM.getInstance());
    ...
    public static final class ADC {
        ...
        public static final byte RM8_IMM8 = (byte) 0x80;
        public static final byte RM64_IMM32 = (byte) 0x81;
        public static final InstructionDefinition RM64_IMM8 = InstructionDefinition.of(Opcode.of(0x83, 2), RM_IMM.getInstance());
    ...
    public static final class SBB {
        ...
        public static final byte RM8_IMM8 = (byte) 0x80;
        public static final byte RM64_IMM32 = (byte) 0x81;
        public static final InstructionDefinition RM64_IMM8 = InstructionDefinition.of(Opcode.of(0x83, 3), RM_IMM.getInstance());
    ...
    public static final class AND {
        ...
        public static final byte RM8_IMM8 = (byte) 0x80;
        public static final byte RM64_IMM32 = (byte) 0x81;
        public static final InstructionDefinition RM64_IMM8 = InstructionDefinition.of(Opcode.of(0x83, 4), RM_IMM.getInstance());
    ...
    public static final class SUB {
        ...
        public static final byte RM8_IMM8 = (byte) 0x80;
        public static final byte RM64_IMM32 = (byte) 0x81;
        public static final InstructionDefinition RM64_IMM8 = InstructionDefinition.of(Opcode.of(0x83, 5), RM_IMM.getInstance());

    }

    public static class XOR {

        public static final InstructionDefinition RM8_R8 = InstructionDefinition.of(Opcode.of(0x30), RM_R.getInstance());
        public static final InstructionDefinition RM64_R64 = InstructionDefinition.of(Opcode.of(0x31), RM_R.getInstance());
        ...
        public static final byte RM8_IMM8 = (byte) 0x80;
        public static final byte RM64_IMM32 = (byte) 0x81;
        public static final InstructionDefinition RM64_IMM8 = InstructionDefinition.of(Opcode.of(0x83, 6), RM_IMM.getInstance());
    ...
    public static final class CMP {
        ...
        public static final byte RM8_IMM8 = (byte) 0x80;
        public static final byte RM64_IMM32 = (byte) 0x81;
        public static final InstructionDefinition RM64_IMM8 = InstructionDefinition.of(Opcode.of(0x83, 7), RM_IMM.getInstance());
    ...
    public static final InstructionDefinition TEST_RM8_IMM8 = InstructionDefinition.of(Opcode.of(0xF6), RM_IMM.getInstance());
    public static final InstructionDefinition NOT_RM8 = InstructionDefinition.of(Opcode.of(0xF6, 2), RM.getInstance());
    public static final InstructionDefinition NEG_RM8 = InstructionDefinition.of(Opcode.of(0xF6, 3), RM.getInstance());
    public static final InstructionDefinition MUL_RM8 = InstructionDefinition.of(Opcode.of(0xF6, 4), RM.getInstance());
    public static final InstructionDefinition IMUL_RM8 = InstructionDefinition.of(Opcode.of(0xF6, 5), RM.getInstance());
    public static final InstructionDefinition DIV_RM8 = InstructionDefinition.of(Opcode.of(0xF6, 6), RM.getInstance());
    public static final InstructionDefinition IDIV_RM8 = InstructionDefinition.of(Opcode.of(0xF6, 7), RM.getInstance());
    public static final InstructionDefinition TEST_RM64_IMM32 = InstructionDefinition.of(Opcode.of(0xF7), RM_IMM.getInstance());
    public static final InstructionDefinition NOT_RM64 = InstructionDefinition.of(Opcode.of(0xF7, 2), RM.getInstance());
    public static final InstructionDefinition NEG_RM64 = InstructionDefinition.of(Opcode.of(0xF7, 3), RM.getInstance());
    public static final InstructionDefinition MUL_RM64 = InstructionDefinition.of(Opcode.of(0xF7, 4), RM.getInstance());
    public static final InstructionDefinition IMUL_RM64 = InstructionDefinition.of(Opcode.of(0xF7, 5), RM.getInstance());
    public static final InstructionDefinition DIV_RM64 = InstructionDefinition.of(Opcode.of(0xF7, 6), RM.getInstance());
    public static final InstructionDefinition IDIV_RM64 = InstructionDefinition.of(Opcode.of(0xF7, 7), RM.getInstance());
    ...
    public static final InstructionDefinition SYSCALL = InstructionDefinition.of(Opcode.of(new byte[]{0x0F, 0x05}), ZO.getInstance());
