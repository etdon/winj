...
public final class Instruction_INC_RM64 extends Instruction {

    private final RegisterAddressor destination;

    private Instruction_INC_RM64(final RegisterAddressor destination) {
    ...
    public byte[] build() {
        ...
        byteBuffer.put(Opcodes.Prefix.of(this.destination.getRegister().isExtended(), sibExtension, false, true));
        byteBuffer.put(Opcodes.Primary.INC_RM64);
        byteBuffer.put(
    ...
    public static Instruction_INC_RM64 of(@NotNull final RegisterAddressor destination) {

        Preconditions.checkNotNull(destination);
        return new Instruction_INC_RM64(destination);
