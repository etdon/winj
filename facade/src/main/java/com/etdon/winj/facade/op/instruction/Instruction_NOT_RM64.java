...
public final class Instruction_NOT_RM64 extends Instruction {
    ...
    private Instruction_NOT_RM64(final RegisterAddressor destination) {
    ...
    public byte[] build() {
        ...
        byteBuffer.put(Opcode.Primary.NOT_RM64);
        byteBuffer.put(
    ...
    public static Instruction_NOT_RM64 of(@NotNull final RegisterAddressor destination) {
