...
public final class Instruction_MOV_R64_IMM64 extends Instruction {
    ...
    public byte[] build() {
        ...
        byteBuffer.put(Opcodes.Prefix.of(this.destination.isExtended(), false, false, true));
        byteBuffer.put((byte) (Opcodes.Primary.MOV.R64_IMM64 | this.destination.getValue()));
