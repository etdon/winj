...
public final class Instruction_ADC_RM64_IMM8 extends Instruction {
    ...
    private Instruction_ADC_RM64_IMM8(final Register64 destination,
                                      final byte value) {
    ...
    public static Instruction_ADC_RM64_IMM8 of(@NotNull final Register64 destination, final byte value) {
