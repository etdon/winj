...
public final class Instruction_ADD_RM64_IMM8 extends Instruction {
    ...
    private Instruction_ADD_RM64_IMM8(final RegisterAddressor destination,
                                      final byte value) {
    ...
    public byte[] build() {
        ...
        byteBuffer.put(Opcode.Primary.ADD.RM64_IMM8);
        byteBuffer.put(
    ...
    public static Instruction_ADD_RM64_IMM8 of(@NotNull final RegisterAddressor destination, final byte value) {
