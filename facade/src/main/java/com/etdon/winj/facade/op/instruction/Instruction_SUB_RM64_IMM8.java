...
public final class Instruction_SUB_RM64_IMM8 extends Instruction {
    ...
    private Instruction_SUB_RM64_IMM8(final Register destination,
                                      final byte value) {
    ...
    public static Instruction_SUB_RM64_IMM8 of(@NotNull final Register destination, final byte value) {
