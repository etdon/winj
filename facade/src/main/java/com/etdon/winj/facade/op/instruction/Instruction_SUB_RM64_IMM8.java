...
public final class Instruction_SUB_RM64_IMM8 extends Instruction {

    private final RegisterAddressor destination;
    private final byte value;

    private Instruction_SUB_RM64_IMM8(final RegisterAddressor destination,
                                      final byte value) {
    ...
    public byte[] build() {
        ...
        byteBuffer.put(Opcode.Primary.SUB.RM64_IMM8);
        byteBuffer.put(
    ...
    public static Instruction_SUB_RM64_IMM8 of(@NotNull final RegisterAddressor destination, final byte value) {

        Preconditions.checkNotNull(destination);
        return new Instruction_SUB_RM64_IMM8(destination, value);
