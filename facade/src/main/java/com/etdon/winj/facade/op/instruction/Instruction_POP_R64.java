...
public final class Instruction_POP_R64 extends Instruction {
    ...
    private Instruction_POP_R64(final Register source) {
    ...
    public byte[] build() {
        ...
        if (source.isExtended()) {
            return new byte[]{
                    ...
                    (byte) (Opcode.Primary.POP_R64 | source.getValue())
            };
        } else {
            return new byte[]{(byte) (Opcode.Primary.POP_R64 | source.getValue())};
        }

    }

    public static Instruction_POP_R64 of(@NotNull final Register source) {
