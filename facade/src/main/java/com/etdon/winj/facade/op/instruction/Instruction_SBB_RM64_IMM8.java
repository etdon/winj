...
public final class Instruction_SBB_RM64_IMM8 extends Instruction {
    ...
    private Instruction_SBB_RM64_IMM8(final RegisterAddressor destination,
                                      final byte value) {
    ...
    public byte[] build() {
        ...
        byteBuffer.put(Opcode.Primary.SBB.RM64_IMM8);
        byteBuffer.put(
    ...
    public static Instruction_SBB_RM64_IMM8 of(@NotNull final RegisterAddressor destination, final byte value) {
