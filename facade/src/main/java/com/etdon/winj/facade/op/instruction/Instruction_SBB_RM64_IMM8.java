...
public final class Instruction_SBB_RM64_IMM8 extends Instruction {
    ...
    private Instruction_SBB_RM64_IMM8(final Register64 destination,
                                      final byte value) {
    ...
    public static Instruction_SBB_RM64_IMM8 of(@NotNull final Register64 destination, final byte value) {
